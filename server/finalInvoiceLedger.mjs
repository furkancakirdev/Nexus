...
SELECT
  ...
  k.MALAD productName,
  k.MARKAAD brandName,
  NULLIF(LTRIM(RTRIM(h.FIYATDOVIZCINS)), '') productCurrency,
  NULLIF(CAST(h.FIYATDOVIZKUR AS decimal(28, 8)), 0) documentSellingRate,
  CAST(h.EVRAKTARIH AS date) documentRateDate,
  h.MIKTAR quantity,
