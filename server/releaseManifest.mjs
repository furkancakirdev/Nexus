...
export function validateReleaseManifest(manifest = {}) {
  ...
  if (!/^\b[0-9a-f]{40}\b$/i.test(String(release.sourceCommit || ""))) errors.push("source-commit-invalid");
  ...
  if (!nonEmpty(release.ssh?.host) || !/^SHA256:[A-Za-z0-9+/=]+$/.test(String(release.ssh?.hostKey || ""))) {
