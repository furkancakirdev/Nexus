...
export function SummaryPage({ rows, settings, employees, targetRows, annualPool, year, mode, onNavigate }) {
  ...
  return <main className="page summary-page" id="top">
    ...
    <section className="summary-kpis">
      ...
      <article><span className="green"><IconWallet /></span><div><small>Net dağıtım havuzu</small><strong>{money.format(annualPool)} TL</strong><p>Hedef bantları, rezerv sonrası</p></div></article>
      ...
      <article><span className="amber"><IconTargetArrow /></span><div><small>Hedef tutan departman-ay</small><strong>{metTargetMonths.length} / {targetMonths.length}</strong><p>Temkinli veya büyüme bandı</p></div></article>
    </section>
