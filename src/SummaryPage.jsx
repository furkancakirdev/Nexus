...
export function SummaryPage({ rows, settings, employees, targetRows, annualPool, year, mode = "demo", onNavigate }) {
  ...
  return <main className="page summary-page" id="top">
    ...
    <section className="summary-kpis">
      <article><span><IconChartBar /></span><div className="label-value"><small>Net satışlar</small><strong>{money.format(totals.sales)} TL</strong><p>{effectiveRows.length} dönem verisi</p></div></article>
